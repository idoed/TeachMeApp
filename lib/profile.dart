        ...
        Padding(
          ...
          child: Stack(
            children: <Widget>[
              CircleAvatar(
                radius: 61,
                child: ClipOval(child: Image.asset('https://www.pexels.com/photo/man-in-toga-holding-diploma-1007066/', height: 150, fit: BoxFit.cover,),),
              ),
            ...
            children: <Widget>[
              Padding(
               ...
               controller: userNameController,
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(20)),border: Border.all(width: 1.0, color: Colors.blue)),
                ),
              ),
              Padding(
